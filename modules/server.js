const express = require('express'); // Importa la librería express para 
// crear e}l servidor web 
const { dbConnection } = require('../database/config'); // Importa la 
// función de conexión a la base de datos 
const cors  = require('cors'); // Importa la librería cors para permitir 
// peticiones desde otros dominios 
const bodyParser = require('body-parser'); // Importa la librería body
// parser para parsear datos del cuerpo de las peticiones HTTP 
 
class Server{ 
 
    constructor(){ 
        this.app = express(); // Inicializa la aplicación express 
        this.port = process.env.PORT; // Obtiene el puerto de conexión desde 
// las variables de entorno 
        this.usuariosPath = '/api/usuarios'; // Define la ruta base para las 
// operaciones relacionadas con usuarios 
        this.authPath = '/api/auth'; // Define la ruta base para las 
...
// servidor y muestra un mensaje en consola 
    ...
    middlewares() { 
        ...
        // Configura body-parser para parsear datos del cuerpo de las 
// peticiones HTTP 
...
// Ruta para las operaciones relacionadas con usuarios 
        this.app.use(this.authPath, require('../routes/auth')); // Ruta para 
// las operaciones de autenticación 
    } 
 
    async connectDb(){ 
        await dbConnection(); // Conecta con la base de datos MongoDB al 
// inicio del servidor 
    } 
} 
 
module.exports = Server; // Exporta la clase Server para que esté disponible 
// para otros módulos 