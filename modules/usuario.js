const { Schema, model } = require('mongoose'); // Importa las funciones Schema 
// y model de mongoose para definir esquemas y modelos de datos 
...
const UsuarioSchema = Schema({
    ...
    email: {
        ...
        required: [true, 'El email es obligatorio'] // Define que el campo 
        // email es obligatorio 
    },

    password: {
        type: String,
        required: [true, 'El password es obligatorio'], // Define que el 
    ...
    rol: {
        ...
        enum: ['Admin', 'Usuario'] // Define que el campo rol solo puede 
        // tener los valores 'Admin' o 'Usuario' 
    },

    estado: {
        type: Boolean,
        default: true, // Define el valor por defecto del campo estado como 
